...
class Session(dict):
    ...
    def __init__(self,rh,name=_defaultCookieName,timeout=_defaultTimeout):
        ...
        rh.response.headers.append('Set-Cookie','%s=%s; path=/;'%(name,self._sid))
    ...
    def invalidate(self):
        ...
        self.rh.response.headers.append('Set-Cookie',
...
class RequestHandler(object):
    def __init__(self, request, response):
        ...
        self.request.str_cookies = Cookie.SimpleCookie()
        self.response = response

session = Session(RequestHandler(request, response))